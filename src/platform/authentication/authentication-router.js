...
router.post('/signin', passport.authenticate('local'), AuthenticationController.signin);
router.get('/me', AuthenticationController.isSignedIn, AuthenticationController.me);
