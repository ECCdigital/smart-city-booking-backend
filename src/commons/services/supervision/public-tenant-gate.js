 ...
 * tenant. The staff of a declined one never get here with that reach:
 * their membership rests in the principal (glossary "Ruhende
 * Mitgliedschaft"), so they are asked as the public and get its 404; only
 * the instance owner keeps every right. The 404 names no reason (§5.2).
 */
