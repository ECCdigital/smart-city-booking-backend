module.exports = {
  ...
  down: async function (mongoose) {
    ...
    try {
      ...
      // Duplicate initiative applications (empty offerId) cannot satisfy the
      // original unique index; fall back to a non-unique index on rollback.
      if (err.code !== 11000) {
        throw err;
      }
      await collection.createIndex(
        { tenantId: 1, offerId: 1, studentUserId: 1 },
        { name: "tenantId_1_offerId_1_studentUserId_1" },
      );
    }
  },
};
