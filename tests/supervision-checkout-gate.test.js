 ...
 * new self-booking of a pending or a declined tenant is refused at every
 * entrance - v1 and v2, single and group, validation - signed in or not, a
 * ticket of an event included; the administration's manual booking stays
 * open.
 */
